<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="LoginCliente.aspx.cs" Inherits="Presentacion.LoginCliente" %>
...
<body class="body">
    <div class="cuadroLogIn">
         <asp:HyperLink ID="HyperLink2" CssClass="encabezadoVolver" runat="server" NavigateUrl="~/SeleccionUsuario.aspx">Seleccion de usuario</asp:HyperLink>
        <h1 class="h1">Iniciar sesión</h1>
        <br />
        <form id="form1" runat="server">
                <asp:Label ID="lblUsuario" CssClass="labels" runat="server">Email</asp:Label>
                <asp:TextBox ID="txtEmail" CssClass="txtUsuario" placeholder="Email" runat="server" TextMode="Email"></asp:TextBox>
                <br />
                <br /> 
                ...
                <asp:HyperLink ID="HyperLink1" CssClass="hlkNuevoUsuario" runat="server" NavigateUrl="~/RegistroCliente.aspx"> aquí</asp:HyperLink>
                <br />
                <br />
                ...
                <br />
                <asp:RequiredFieldValidator ID="rfvEmail" CssClass="validadores" runat="server" ControlToValidate="txtEmail" ErrorMessage="*Ingrese un email"></asp:RequiredFieldValidator>  
                <br />
